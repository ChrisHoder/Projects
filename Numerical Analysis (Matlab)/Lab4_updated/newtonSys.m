...
function [thetaN,i,error] = newtonSys(theta,tol,nMax,theta4_input,linkLength)
    % save initial values
    ...
    fn = subs(fn,{r1, r2,r3,r4,theta4},{linkLength(1),linkLength(2),linkLength(3), linkLength(4), theta4_ins});
    %define iterator
    i = 2;
