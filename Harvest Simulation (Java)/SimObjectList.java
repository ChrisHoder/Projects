...
public class SimObjectList {
   ...
   */
  public void shuffle(){
    ArrayList simList = (ArrayList) this.toList();
    this.clear();
    ...
    for(int i=simList.size()-1; i>=0; i--){
    	...
    	// when i = 0 there is only 1 element left unswitched, the first
    	else{
    		index = 0;
    	}
    	...
    	//get SimObject at this locaiton
    	temp = (SimObject)simList.get(index);
    	// put SimObject in the ith spot in the list and get what was there.
    	temp2 = (SimObject)simList.set(i, temp);
  ...
  public static void main(String[] args) {
	 SimObjectList sO = new SimObjectList();
	 System.out.println(sO.toString());
	 System.out.println(((ArrayList)sO.toList()).size());
	 System.out.println("The size is " + sO.size());
	 for(int i=0; i<10;i++){
		 sO.addAtFront(new SocialAgent(i,i,i));
	 }
	 System.out.println(sO.toString());
	 System.out.println("The size is " + sO.size());
	 sO.shuffle();
	 ...
	 sO.clear();
	 System.out.println(sO.toString() + "  " + sO.size());
  }
}
